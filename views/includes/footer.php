        ...
        <footer class="footer">
          <div class="card">
            <div class="card-body">
              ...
              <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Derechos de autor © <a href="https://www.facebook.com/Ugel16Barranca" target="_blank">UGEL N.° 16</a> 2024</span>
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Desarrollado por <a href="https://www.facebook.com/profile.php?id=100054302195210" target="_blank">Miranda Cristian</a></span>
...
<script>
    ...
    function message(tipo, mensaje) {
        Snackbar.show({
            text: mensaje,
            pos: 'top-right',
            backgroundColor: tipo == 'success' ? '#008000' : '#8B0000',
            actionText: 'Cerrar'
        });
    }
    ...
    function salir(params) {
      Snackbar.show({
    text: '¿USTED ESTA SEGURO DE FINALIZAR LA SESIÓN?',
    width: '475px',
    actionText: 'SI, SALIR',
