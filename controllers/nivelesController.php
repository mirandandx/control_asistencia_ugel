...
switch ($option) {
    case 'listar':
        ...
        for ($i = 0; $i < count($data); $i++) {
            $data[$i]['accion'] = '<div class="gap-2">
                <a class="btn btn-danger btn-sm mr-1" onclick="eliminar(' . $data[$i]['id'] . ')"><i class="fas fa-eraser"></i></a>
                <a class="btn btn-primary btn-sm mr-1" onclick="edit(' . $data[$i]['id'] . ')"><i class="fas fa-edit"></i></a>
            </div>';
        }
